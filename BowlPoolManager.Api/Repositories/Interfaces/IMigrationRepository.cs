...
namespace BowlPoolManager.Api.Repositories
{
    public interface IMigrationRepository
    {
        ...
        Task<(List<LegacyGameDto> Games, List<string> TeamNames, List<string> SeasonIds, List<LegacyPoolDto> Pools, int EntryCount, string DebugInfo)> AnalyzeLegacyDataAsync();
